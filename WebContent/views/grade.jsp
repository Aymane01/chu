<%@page import="org.chu.greve.models.Grade"%>
      ...
      <div class="main_container">
		...
		<div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Form Ajout / Modification des Grades</h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="../chu/addGrade">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                     ...
                     <table id="datatable" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
                      ...
                      <%
							List<Grade> liste = (List<Grade>) request.getAttribute("model");
							for(Grade grd : liste){
						%>
	
		<tr role="row" class="odd">
			<td class="sorting_1"><% out.println(grd.getIdG());  %></td> 
			<td><%= grd.getIntituleFr() %></td>
			<td><%= grd.getIntituleAr() %></td>
			<td><a href="../chu/RemoveGrade?id=<%= grd.getIdG() %>" >Remove</a></td>
			<td><input type="button" onclick="copy(<%= grd.getIdG() %>,<%= grd.getIntituleFr() %>,<%= grd.getIntituleAr()%>);" value="Modifier" ></td>
		</tr>
